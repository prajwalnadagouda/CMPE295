...
print("Elastic Net model accuracy(variance):", sqrt(metrics.mean_absolute_percentage_error(y_test, y_pred)))
...
plt.xlabel('Actual')
plt.ylabel('Predicted')
plt.title('Elastic Net - Test Data: Actual vs Predicted')
plt.legend()
plt.show()
