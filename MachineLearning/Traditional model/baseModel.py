...
print("Decision Tree model accuracy(variance):", sqrt(metrics.mean_absolute_percentage_error(y_test, y_pred)))
...
plt.xlabel('Actual')
plt.ylabel('Predicted')
plt.title('Decision Tree - Test Data: Actual vs Predicted')
plt.legend()
